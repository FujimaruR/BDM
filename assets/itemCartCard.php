<div class="col-xl-3">
    <div class="card cardSectionBar">
        <div class="modal-header">
            ...
            data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $productId;?>"></button>
        </div>
...
<div class="modal fade" id="staticBackdrop<?php echo $productId;?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                data-bs-target="#exampleModal<?php echo $productId;?>">Aceptar</button>
            </div>
        </div>
    </div>
</div>
