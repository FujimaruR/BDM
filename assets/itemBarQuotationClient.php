    ...
    <div class="row g-0">
        <div class="modal-header">
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
             data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $quotationClientId;?>"></button>
        </div>
        <div class="col-md-2">
...
<div class="modal fade" id="staticBackdrop<?php echo $quotationClientId;?>" data-bs-backdrop="static" 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $quotationClientId;?>">Aceptar</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="exampleModal<?php echo $quotationClientId;?>" tabindex="-1" 
aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Has borrado la solicitud de cotización para <?php echo $quotationClientQuantity; ?>
                 <?php echo $quotationClientProduct ?>(s)
            </div>
            <div class="modal-footer">
