            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $quotationSellerId; ?>">Rechazar</button>
                    </div>

                    <div class="col">
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" 
                        data-bs-target="#confirmationModal<?php echo $quotationSellerId; ?>">Aceptar</button>
                    </div>
...
<!-- Modal -->
<div class="modal fade" id="staticBackdrop<?php echo $quotationSellerId; ?>" data-bs-backdrop="static" 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" data-bs-dismiss="modal" data-bs-toggle="modal"
                 data-bs-target="#exampleModal<?php echo $quotationSellerId; ?>">Aceptar</a>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="exampleModal<?php echo $quotationSellerId; ?>" tabindex="-1"
...
<div class="modal fade" id="confirmationModal<?php echo $quotationSellerId; ?>" tabindex="-1" 
aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="col-md form-group">
                                ...
                                <input type="number" class="form-control" id="productPriceQuotation<?php 
                                echo $quotationSellerId;?>" placeholder="$ 0.00"
                                 onkeypress="floatingNum(<?php echo $quotationSellerId;?>);"
                                  onkeyup="multiplyQuantityProducts(<?php echo $quotationSellerId;?>);" required>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="col">
                                <div class="col-md form-group">
                                    ...
                                    <input type="number" class="form-control" id="productCuantityQuotation<?php 
                                    echo $quotationSellerId;?>" value="<?php echo $quotationSellerQuantity?>" 
                        ...
                        <div class="col">
                            <div class="col">
                                <div class="col-md form-group">
                                    ...
                                    <input class="form-control" id="totalPriceQuotation<?php echo $quotationSellerId;?>"
                                     placeholder="$ 0.00" readonly>
                                </div>
                            </div>
