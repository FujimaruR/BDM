<div class="card mb-3" id="list<?php echo $categoryId;?>">
    ...
    <div class="row g-0">
        <div class="modal-header">
            ...
            data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $categoryId;?>"></button>
        </div>
        <div class="col-md-2">
...
<div class="modal fade" id="staticBackdrop<?php echo $categoryId;?>" data-bs-backdrop="static" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                 data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $categoryId;?>">Aceptar</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="exampleModal<?php echo $categoryId;?>" tabindex="-1" 
