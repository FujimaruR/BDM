    ...
    <form method="POST" action="#" onsubmit="myFunction();" id="myForm">
            ...
            <div class="row">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckPassword" 
                    onclick="formPasswordDisable();">
            ...
            <div class="row">
                ...
                <div class="col-md form-group">
                    ...
                    <input class="form-control" type="password" id="formPasswordConfirm"
                     placeholder="Confirma la contraseña..." disabled>
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="d-grid gap-2">
                    <div class="col-md form-group">
                        ...
                        <input class="form-control" type="password" id="formActualPassword" 
